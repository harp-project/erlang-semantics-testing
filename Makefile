...
BENCH_PREFIX=bench/
GIT_TESTS=length.erl length_c.erl length_u.erl nrev.erl qsort.erl smith.erl tak.erl zip_nnc.erl fib.erl
...
check: all
	./scripts.erl $(COR_TESTS) $(addprefix $(BENCH_PREFIX), $(GIT_TESTS))
